        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="space-y-8 text-center md:text-left order-2 md:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link
                href="/produtos"
                className="inline-flex items-center justify-center rounded-full bg-gold px-8 py-3.5 text-sm font-medium tracking-wide text-white transition-all duration-200 hover:bg-gold-hover hover:shadow-md"
              >
                Ver Produtos
              </Link>
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-gold px-8 py-3.5 text-sm font-medium tracking-wide text-gold transition-all duration-200 hover:bg-gold hover:text-white"
              >
