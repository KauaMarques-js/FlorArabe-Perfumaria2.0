      ...
      <div className="max-w-[1280px] mx-auto px-6 py-16">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <Link href="/" className="flex flex-col items-center">
            ...
            <span className="text-[9px] tracking-[0.35em] uppercase text-text-secondary mt-0.5">
              Perfumaria
            </span>
          </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            {/* WhatsApp */}
            <a
              href="https://wa.me/5565999721093"
              target="_blank"
              rel="noopener noreferrer"
              className="text-text-secondary hover:text-gold transition-colors duration-200"
              aria-label="WhatsApp"
          ...
          <p className="text-xs text-text-secondary/60">
            © {currentYear} Flor Árabe Perfumaria. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
