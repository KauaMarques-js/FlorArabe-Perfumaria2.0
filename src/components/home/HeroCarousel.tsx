  ...
  return (
    <div className="relative w-72 h-96 md:w-80 md:h-[28rem] lg:w-96 lg:h-[32rem] group flex flex-col items-center">
      ...
      <div
        ...
        className="relative w-full h-full overflow-hidden rounded-2xl bg-surface border border-border/30 p-4 flex items-center justify-center shadow-sm"
      >
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-surface-elevated/90 backdrop-blur-md px-4 py-2.5 rounded-full border border-border/40 shadow-sm transition-all duration-300 hover:bg-surface-elevated flex items-center gap-3 z-10">
          <Link
